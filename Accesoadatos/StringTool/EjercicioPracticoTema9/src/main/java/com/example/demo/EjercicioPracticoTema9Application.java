...
// Este es el main de la aplicación, aqui es donde se encuentra el codigo
// que realmente se ejecuta al iniciar la aplicación. El codigo de este
// archivo se base en el codigo del archivo Consultas.java
...
public class EjercicioPracticoTema9Application {
	...
	public static void main(String[] args) {
		...
		m1.createManga(Manga1);
		Manga1 = new Manga("The Promised Neverland", "Kaiu Shirai y Posuka Demizu", "Drama, misterio, suspense", 2016,
				22);
		m1.createManga(Manga1);
		...
		// Creamos una lista de objetos manga en la cual introduciremos los datos de la
		// consulta
		...
		// Utiliza Hibernate para realizar transacciones sobre la base de datos. Por
		// ejemplo, podrías
		// crear una transacción que permita crear un nuevo manga y actualizar el número
		// de
		// volúmenes de otro manga en una sola operación, garantizando que ambas
		// operaciones

...
public class Iphone {
    ...
    public Iphone(int id, String nombre, double precio, int stock, String procesador, int ram, int almacenamiento, String color,ArrayList<Integer> accesorios) {
        super();
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
    ...
    public String toString() {
        return "Iphone [id=" + id + ", nombre=" + nombre + ", precio=" + precio + ", stock=" + stock + ", procesador="

...
public class Mac {
    ...
    public Mac(int id, String nombre, double precio, int stock, String procesador, int ram, int almacenamiento, String color,ArrayList<Integer> accesorios) {
        super();
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
    ...
    public String toString() {
        return "Mac [id=" + id + ", nombre=" + nombre + ", precio=" + precio + ", stock=" + stock + ", procesador="

...
public class AirPods {
    ...
    public AirPods(int id, String nombre, double precio, int stock, String color, ArrayList<Integer> compatibilidad) {
        super();
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
    ...
    public String toString() {
        return "AirPods [id=" + id + ", nombre=" + nombre + ", precio=" + precio + ", stock=" + stock + ", color=" + color

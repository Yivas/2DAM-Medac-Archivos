...
public class pruebaDom {
    ...
    public static void main(String[] args) {
       File archivo = new File("C:\\Users\\Usuario\\Documents\\Portatil Medac\\2DAM-Medac-Archivos\\Accesoadatos\\XML\\libros.xml");
       System.out.println(abrir_XML_DOM(archivo));
